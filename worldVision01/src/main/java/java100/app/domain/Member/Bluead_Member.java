...
public class Bluead_Member {
int no;
String member_id;
String member_nick;
String member_pass;
String member_name;
String member_reg_no1;
String member_reg_no2;
String member_birth1;
String member_birth2;
String member_email;
String member_zip1;
String member_zip2;
...
public String toString() {
	return "Bluead_Member [no=" + no + ", member_id=" + member_id + ", member_nick=" + member_nick + ", member_pass="
			+ member_pass + ", member_name=" + member_name + ", member_reg_no1=" + member_reg_no1 + ", member_reg_no2="
			+ member_reg_no2 + ", member_birth1=" + member_birth1 + ", member_birth2=" + member_birth2
			+ ", member_email=" + member_email + ", member_zip1=" + member_zip1 + ", member_zip2=" + member_zip2
			+ ", member_address1=" + member_address1 + ", member_address2=" + member_address2 + ", member_tel1="
			+ member_tel1 + ", member_tel2=" + member_tel2 + ", member_tel3=" + member_tel3 + ", member_htel1="
			+ member_htel1 + ", member_htel2=" + member_htel2 + ", member_htel3=" + member_htel3 + ", member_join_type="
			+ member_join_type + ", member_join_date=" + member_join_date + "]";
}
public int getNo() {
	return no;
}
