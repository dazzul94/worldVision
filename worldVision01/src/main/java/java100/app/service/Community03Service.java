...
import java100.app.domain.Community03;
...
// 가능한 업무 용어를 사용한다.
//
public interface Community03Service {
    List<Community03> list(int pageNo, int pageSize, Map<String,Object> options);
    Community03 get(int no);
