...
import java100.app.domain.Community05;
...
// 가능한 업무 용어를 사용한다.
//
public interface Community05Service {
    List<Community05> list(int pageNo, int pageSize, Map<String,Object> options);
    Community05 get(int no);
