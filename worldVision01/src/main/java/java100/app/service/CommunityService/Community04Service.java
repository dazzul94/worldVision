...
import java100.app.domain.Community.Community04;
...
// 가능한 업무 용어를 사용한다.
//
public interface Community04Service {
    List<Community04> list(int pageNo, int pageSize, Map<String,Object> options);
    Community04 get(int no);
