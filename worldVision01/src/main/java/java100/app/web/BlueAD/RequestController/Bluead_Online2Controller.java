...
@Controller
@RequestMapping("/request/bluead_online2")
public class Bluead_Online2Controller {
    
    @Autowired Bluead_Online2Service bluead_online2Service;
    
    static Logger logger = Logger.getLogger(Bluead_Online2Controller.class);
    ...
    public String list(
        ...
        int totalCount = bluead_online2Service.getTotalCount(options);
        ...
        model.addAttribute("list", bluead_online2Service.list(pageNo, pageSize, options));
        
        return "BlueAD/request/bluead_online2/list";
    }
    
    @RequestMapping("{no}")
    public String view(@PathVariable int no, Model model) throws Exception {
        
        model.addAttribute("bluead_online", bluead_online2Service.get(no));
        return "BlueAD/request/bluead_online2/view";
    }
/*    
    @RequestMapping("add")
    ...
    */
    ...
    public String form() throws Exception {
        return "BlueAD/request/bluead_online2/form";
        
    }
    @RequestMapping("update")
    public String update(HttpServletRequest request, Bluead_Online2 bluead_Online2) throws Exception {
        
        bluead_online2Service.update(bluead_Online2);
        return "redirect:" +  (String)request.getHeader("Referer");
    }
    @RequestMapping("delete")
    public String delete(int no) throws Exception {

        bluead_online2Service.delete(no);
        return "redirect:list";
    }
    ...
    public String deleteAll(HttpServletRequest request, String no) throws Exception {
        ...
        bluead_online2Service.deleteAll(numbers);
