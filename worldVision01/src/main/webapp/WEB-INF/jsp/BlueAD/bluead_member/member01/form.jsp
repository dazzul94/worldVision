...
<table width="100%" align="center" bgcolor="#cad4e3" border="0" cellspacing="1" cellpadding="0">
  <tbody><tr>
   ...
   <tr>
    <td width="100" height="35" class="field_b_pad_p">비밀번호</td>
    <td style="padding-left: 10px;" bgcolor="#ffffff"><b>${bluead_member.member_pass}</b></td><!--  인풋박스 -->
  </tr>
   <tr>
    <td width="100" height="35" class="field_b_pad_p">주민번호</td>
    <td style="padding-left: 10px;" bgcolor="#ffffff"><b>${bluead_member.member_reg_no2}</b></td>
  </tr>
  <tr>
    <td width="100" height="35" class="field_b_pad">생년월일</td>
    <td style="padding-left: 10px;" bgcolor="#ffffff"><b>${bluead_member.member_birth1}&nbsp;${bluead_member.member_birth2}</b></td><!--  인풋박스 ,체크박스-->
  </tr>
  <tr>
    <td width="100" height="35" class="field_b_pad">전화번호</td>
    <td style="padding-left: 10px;" bgcolor="#ffffff"><b>${bluead_member.member_tel1}-${bluead_member.member_tel2}-${bluead_member.member_tel3}</b></td><!--  인풋박스 -->
  </tr>
  <tr>
    <td width="100" height="35" class="field_b_pad_p">휴대전화</td>
    <td style="padding-left: 10px;" bgcolor="#ffffff"><b>${bluead_member.member_htel1} -${bluead_member.member_htel2}-${bluead_member.member_htel3}</b></td><!--  인풋박스 -->
  </tr>
  <tr>
    <td width="100" height="35" class="field_b_pad">주소</td>
    <td style="padding-left: 10px;" bgcolor="#ffffff"><b>${bluead_member.member_address2}<br>${bluead_member.member_address1}</b></td><!--  인풋박스 -->
  </tr>

      <tr>
    <td width="100" height="35" class="field_b_pad">이메일</td>
    <td style="padding-left: 10px;" bgcolor="#ffffff">${bluead_member.member_email}</td><!--  인풋박스 -->
  </tr>
</tbody></table>
</form>
