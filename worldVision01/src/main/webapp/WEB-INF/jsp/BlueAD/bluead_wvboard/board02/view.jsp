    ...
    <td width="100%" height="29" align="center" colspan="6">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td background="${contextPath}/images/BlueAD/skin/bbs/bluead_gray/bluead_bg.gif" style="padding-left:10"><span class="bbs_normal">${bluead_wvboard02.bbs_subject } </span></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td style="padding-left:10">
            <a href="email_send.php?email=d3ZjaG9pckB3dmNob2lyLm9yLmty" target="email_frm" class="bbs_link"><span class="bbs_normal">${bluead_wvboard02.bbs_name }</span></td>
          <td width="70" align="center"><img src="${contextPath}/images/BlueAD/skin/bbs/bluead_gray/bluead_view_date.gif"></td>
          <td width="120" align="center"><span class="bbs_normal">${bluead_wvboard02.bbs_date }</span></td>
          <td width="70" align="center"><img src="${contextPath}/images/BlueAD/skin/bbs/bluead_gray/bluead_view_hit.gif"></td>
          <td width="45" align="center"><span class="bbs_normal">${bluead_wvboard02.bbs_hit }</span></td>
        </tr>
      </table>
    </td>
  </tr>
...
${bluead_wvboard02.bbs_thumb1 }
   ...
   <tr>
    <td height="15" colspan="6" class="bbs_padding_right" align="right"><span class="bbs_small_1">${bluead_wvboard02.bbs_ip }</span></td>
  </tr>
    <tr>
    <td height="5"></td>
  </tr>
