...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="25" class="txt_blue_b"><img src="${contextPath}/images/BlueAD/admin/title_icon.gif" align="absmiddle"><font color="#5555aa"> 웹진</font></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>  
      ...
      <tr height="30">
        ...
        <td align="center" bgcolor="#f1f1f1"></td>
        <td bgcolor="#f1f1f1">&nbsp;&nbsp;&nbsp;<a href="${board.bbs_no}" class="bbs_link">${board.bbs_subject}</a></td>
        <td align="center" bgcolor="#f1f1f1"></td>
