...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody><tr>
    <td height="25" class="txt_blue_b"><img src="${contextPath}/images/BlueAD/admin/title_icon.gif" align="absmiddle"> 갤러리</td>
  </tr>
  <tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="4" align="center" background="${contextPath}/images/BlueAD/skin/bbs/bluead_gray/bluead_bg.gif"><img src="${contextPath}/images/BlueAD/skin/bbs/bluead_gray/bluead_right.gif"></td>
         ...
         <!-- -----------------공지리스트 --------------------------->
      <c:forEach items="${list}" var="community04" varStatus="status">
      <c:if test="${community04.bbs_notice eq 'Y'}">
      <tr height="30">
        ...
        <td align="center" bgcolor="#f1f1f1"></td>
        <td bgcolor="#f1f1f1">&nbsp;&nbsp;&nbsp;<a href="${community04.bbs_no}" class="bbs_link">${community04.bbs_subject}</a></td>
        <td align="center" bgcolor="#f1f1f1"></td>
        ...
        <td align="center" bgcolor="#f1f1f1"><span class="bbs_normal">${community04.bbs_date}</span>
        </td>
        <td align="center" bgcolor="#f1f1f1"></td>
        <td align="center" bgcolor="#f1f1f1"><span class="bbs_normal">${community04.bbs_hit}</span></td>
      </tr>
     <tr>
    ...
    <c:forEach items="${list}" var="community04" varStatus="status">
      <tr height="30">
        <td align="center"></td>
        <td align="center"><input type="checkbox" name="bbs_no[]" value="${community04.bbs_no}" style="cursor:hand"></td>
        <td align="center"><span class="bbs_normal">${community04.bbs_no}</span></td>
        <td align="center"></td>
        <td>&nbsp;&nbsp;&nbsp;<a href="${community04.bbs_no}" class="bbs_link">${community04.bbs_subject} </a>
        </td>
        <td></td>
        <td align="center">
          <a href="email_send.php?email=d3ZjaG9pckB3dmNob2lyLm9yLmty" target="email_frm" class="bbs_link"><img src="${contextPath}/images/BlueAD/skin/bbs/1198130437.gif" align="absmiddle"></a>        
        ...
        <td align="center"></td>
        <td align="center"><span class="bbs_normal">${community04.bbs_date}</span></td>
        <td align="center"></td>
        <td align="center"><span class="bbs_normal">${community04.bbs_hit}</span></td>
        <td align="center"></td>
      </tr>
      <tr>
        <td bgcolor="#e6e6e6"></td>
