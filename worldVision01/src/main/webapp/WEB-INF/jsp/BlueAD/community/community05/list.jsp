...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody><tr>
    <td height="25" class="txt_blue_b"><img src="${contextPath}/images/BlueAD/admin/title_icon.gif" align="absmiddle"> 비전싱어즈</td>
  </tr>
  <tr>
...
<td>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr height="30">
        ...
        <td align="center" bgcolor="#f1f1f1"></td>
        <td bgcolor="#f1f1f1">&nbsp;&nbsp;&nbsp;<a href="${community05.bbs_no}" class="bbs_link">${community05.bbs_subject}</a></td>
        <td align="center" bgcolor="#f1f1f1"></td>
    ...
    <c:forEach items="${list}" var="community05" varStatus="status">
      <tr height="30">
        <td align="center"></td>
        <td align="center"><input type="checkbox" name="bbs_no[]" value="${community05.bbs_no}" style="cursor:hand"></td>
        <td align="center"><span class="bbs_normal">${community05.bbs_no}</span></td>
        <td align="center"></td>
        <td>&nbsp;&nbsp;&nbsp;<a href="${community05.bbs_no}" class="bbs_link">${community05.bbs_subject} </a>
        </td>
        <td></td>
        <td align="center">
          <a href="email_send.php?email=d3ZjaG9pckB3dmNob2lyLm9yLmty" target="email_frm" class="bbs_link"><img src="${contextPath}/images/BlueAD/skin/bbs/1198130437.gif" align="absmiddle"></a>        
