...
<div id="content">
<form action="planUpdate" onsubmit="return checkIt();"method='post' enctype="multipart/form-data">
    ...
    <td height="1" background="${contextPath}/images/BlueAD/admin/title_dot_line.gif"></td>
					...
					<table align="center" border="0" cellpadding="10" cellspacing="3" width="100%">
						...
						<tr>
							...
							<textarea  name="content" id="ir1" rows="40" cols="250">${bluead_plan.content}</textarea>
							</td>
						</tr>
					</table>			
