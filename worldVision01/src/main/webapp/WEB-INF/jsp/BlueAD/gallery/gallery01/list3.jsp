...
<option value="소원">소원</option>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <c:if test="${gallery.bbs_notice eq 'Y'}">
      <tr height="30">
        ...
        <td align="center" bgcolor="#f1f1f1"></td>
        <td bgcolor="#f1f1f1">&nbsp;&nbsp;&nbsp;<a href="${gallery.bbs_no}" class="bbs_link">${gallery.bbs_subject}</a></td>
        <td align="center" bgcolor="#f1f1f1"></td>
        ...
        <td align="center" bgcolor="#f1f1f1"><span class="bbs_normal">${gallery.bbs_date}</span>
        </td>
        <td align="center" bgcolor="#f1f1f1"></td>
        <td align="center" bgcolor="#f1f1f1"><span class="bbs_normal">${gallery.bbs_hit}</span></td>
      </tr>
     <tr>
    ...
    <c:forEach items="${list}" var="gallery" varStatus="status">
     <tr height="30" bgcolor="#FFFFFF" onmouseover="this.style.background=&quot;#f5f5f5&quot;" onmouseout="this.style.background=&quot;#ffffff&quot;" style="background: rgb(255, 255, 255);">
        <td align="center">
        <!-- 전체 선택  -->
        <td align="center"><input type="checkbox" id="check" name="check[]"  class="checkSelect"value="${gallery.bbs_no}" style="cursor:pointer"></td>
          <td align="center">${(totalCount - status.index) - ((pageNo - 1) * pageSize)}</td>
        <td align="center"></td>
        <td>&nbsp;&nbsp;&nbsp;<a href="${gallery.bbs_no}" class="bbs_link">${gallery.bbs_subject} </a>
        </td>
        <td></td>
        <td align="center">
          <a href="email_send.php?email=d3ZjaG9pckB3dmNob2lyLm9yLmty" target="email_frm" class="bbs_link"><img src="${contextPath}/images/BlueAD/skin/bbs/1198130437.gif" align="absmiddle"></a>        
        ...
        <td align="center"></td>
        <td align="center"><span class="bbs_normal">${gallery.bbs_date}</span></td>
        <td align="center"></td>
        <td align="center"><span class="bbs_normal">${gallery.bbs_hit}</span></td>
        <td align="center"></td>
      </tr>
      <tr>
        <td bgcolor="#e6e6e6"></td>
