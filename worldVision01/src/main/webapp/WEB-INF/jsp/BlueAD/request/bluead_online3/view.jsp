...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody><tr>
    <td height="25" class="txt_blue_b"><img src="${contextPath}/images/BlueAD/admin/title_icon.gif" align="absmiddle"> 음반구입신청</td>
  </tr>
  <tr>
...
<table width="100%" align="center" bgcolor="#cad4e3" border="0" cellspacing="1" cellpadding="0">
  ...
  <tr height="40">
    ...
    <tr>
    <td width="100" height="35" class="field_b_pad">구입음반</td>
    <td style="padding: 10px;" bgcolor="#ffffff">${bluead_online.tpe3_opt1}</td>
  </tr>
  <tr>
    <td width="100" height="35" class="field_b_pad">구입악보</td>
    <td style="padding: 10px;" bgcolor="#ffffff">${bluead_online.tpe3_opt2}</td>
  </tr>
  <tr>
    <td width="100" height="35" class="field_b_pad">수량</td>
    <td style="padding: 10px;" bgcolor="#ffffff"><c:if test="${!empty bluead_online.tpe3_opt3}">${bluead_online.tpe3_opt3} 개</c:if></td>
  </tr>
  <tr>
    <td width="100" height="35" class="field_b_pad">입금금액</td>
    <td style="padding: 10px;" bgcolor="#ffffff"><c:if test="${!empty bluead_online.tpe3_opt4}">${bluead_online.tpe3_opt4} 원 (배송료 2,500원 포함)</c:if></td>
  </tr>
    <tr>
