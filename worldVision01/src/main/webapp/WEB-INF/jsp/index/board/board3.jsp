           	...
           	<div class="contentWrap">
                ...
                <c:choose>
					...
					<div class="pagerWrap">
						...
						<a href="board3?cPage=1"><img src="${contextPath }/images/index/board/frontArr.png" alt="맨앞으로" /></a>
						...
						<a href="board3?cPage=${maxPage}"><img src="${contextPath }/images/index/board/backArr.png" alt="맨뒤로" /></a>
            		...
            		<div class="pagerWrap">
						...
						<a href="board3?cPage=1&search=${search }&cateSelect=${cateSelect}&sText=${sText}"><img src="${contextPath }/images/index/board/frontArr.png" alt="맨앞으로" /></a>
						...
						<a href="board3?cPage=${maxPage}&search=${search }&cateSelect=${cateSelect}&sText=${sText}"><img src="${contextPath }/images/index/board/backArr.png" alt="맨뒤로" /></a>
