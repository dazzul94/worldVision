				...
				<table>
                	...
                	<c:choose>
						<c:when test="${startPage != 1 }">
							<a href="gallery2?cPage=${startPage - 10 }"><img src="${contextPath }/images/index/board/frontArr.png" alt="맨앞으로" /></a>
						</c:when>
						<c:otherwise>
						...
						<c:forEach begin="${startPage }" end="${endPage }" step="1" var="i">
							<c:choose>
								<c:when test="${cPage == i }">
									<a href="gallery2?cPage=${i }" class="on">${i }</a>
								</c:when>
								<c:otherwise>
									<a href="gallery2?cPage=${i }">${i }</a>
								</c:otherwise>
							</c:choose>
						</c:forEach>
                		...
                		<c:when test="${startPage+10 < maxPage }">
							<a href="gallery2?cPage=${startPage + 10}"><img src="${contextPath }/images/index/board/backArr.png" alt="맨뒤로" /></a>	
						</c:when>
						<c:otherwise>
            		...
            		<div class="pagerWrap">
						...
						<c:choose>
                		<c:when test="${startPage != 1 }">
							<a href="gallery2?cPage=${startPage - 10 }&search=${search }&cateSelect=${cateSelect}&sText=${sText}"><img src="${contextPath }/images/index/board/frontArr.png" alt="맨앞으로" /></a>
						</c:when>
						<c:otherwise>
							<img src="${contextPath }/images/index/board/frontArr.png" alt="맨앞으로" />
						</c:otherwise>
						...
						<c:choose>
                		<c:when test="${startPage+10 < maxPage }">
							<a href="gallery2?cPage=${startPage + 10}&search=${search }&cateSelect=${cateSelect}&sText=${sText}"><img src="${contextPath }/images/index/board/backArr.png" alt="맨뒤로" /></a>	
						</c:when>
						<c:otherwise>
							<img src="${contextPath }/images/index/board/backArr.png" alt="맨뒤로" />
						</c:otherwise>
